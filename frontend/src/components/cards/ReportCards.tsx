...
import DefaultLogo from "@/assets/campus_utec.jpg"
...
export const ReportCard = ({ data }: { data: Report }) => {
    ...
    return (
        <article className="rounded-md border border-gray-200 bg-white shadow-sm overflow-hidden">
            <img src={data.image_url ?? DefaultLogo} alt="Imagen del reporte" className="w-full h-40 object-cover" />
            <div className="p-4 sm:p-5">
                ...
                <Link to={`/report/${data.id_reporte}`} className="text-base sm:text-lg font-semibold text-gray-900">
